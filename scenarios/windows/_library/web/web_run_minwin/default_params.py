...
def run_user_only():
    ...
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_excel_run_r1')
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_excel_run_r2')
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_excel_run_r3')
    ...
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_powerpoint_run_r1')
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_powerpoint_run_r2')
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_powerpoint_run_r3')
    ...
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_word_run_r2')
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_word_run_r3')
    ...
    import_run_user_only('scenarios\\windows\\_library\\web\\site\\web_site_youtube_tos_revisit')
