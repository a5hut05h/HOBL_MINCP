...
def run_user_only():
    ...
    import_run_user_only('scenarios\\windows\\_library\\misc\\open_file_explorer')
    ...
    import_run_user_only('scenarios\\windows\\_library\\productivity\\prod_outlook_run_mincp')
