...
# Description:
#   Switches to an open PowerPoint deck, applies a Fly In animation from the bottom, and saves it.

class ProdPowerpointRunCmR1(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_powerpoint_run_cm_r1.json")
