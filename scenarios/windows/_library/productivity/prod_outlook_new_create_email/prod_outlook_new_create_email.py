...
# Description:
#   Opens a new email compose form in New Outlook.

class ProdOutlookNewCreateEmail(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_outlook_new_create_email.json")
