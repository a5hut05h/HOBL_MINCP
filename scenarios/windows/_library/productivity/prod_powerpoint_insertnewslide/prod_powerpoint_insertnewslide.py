...
# Description:
#   Inserts a new slide into an open PowerPoint deck.

class ProdPowerpointInsertnewslide(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_powerpoint_insertnewslide.json")
