...
# Description:
#   Composes an email and attaches a Word document in New Outlook.

class ProdOutlookNewRunCmR3(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_outlook_new_run_cm_r3.json")
