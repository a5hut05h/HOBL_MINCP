...
# Description:
#   Switches to an open PowerPoint deck, pastes clipboard content, exports a PDF, and saves the deck.

class ProdPowerpointRunCmR3(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_powerpoint_run_cm_r3.json")
