...
# Description:
#   Inserts a specified picture into an open PowerPoint deck.

class ProdPowerpointInsertpicture(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_powerpoint_insertpicture.json")
