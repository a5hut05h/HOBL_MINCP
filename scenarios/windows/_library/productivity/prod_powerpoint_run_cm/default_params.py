...
def run():
    ...
    run_user_only()
    Params.setDefault('prod_powerpoint_run_cm', 'deck_path', 'C:\abl_docs\sample.pptx', desc='Set the path of the PowerPoint deck to open', valOptions=['C:\\abl_docs\\sample.pptx'])
    return
