...
# Description:
#   Launches PowerPoint and opens a presentation from C:\abl_docs.

class ProdPowerpointRunCm(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_powerpoint_run_cm.json")
