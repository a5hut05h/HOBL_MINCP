...
def run():
    ...
    run_user_only()
    Params.setDefault('prod_outlook_new_atttachfile', 'file_source', 'Local', desc='Choose whether to attach the file from OneDrive or the local user profile', valOptions=['OneDrive', 'Local'])
