...
# Description:
#   Discards an open email draft in New Outlook.

class ProdOutlookNewDiscardEmail(core.app_scenario.Scenario):
    ...
    def setUp(self):
        # Load actions JSON.
        actions_json = os.path.join(os.path.dirname(__file__), "prod_outlook_new_discard_email.json")
