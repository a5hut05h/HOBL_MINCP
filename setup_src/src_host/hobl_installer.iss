...
#define MyAppName "hobl_installer"
...
CreateAppDir=no
OutputDir=..\..
OutputBaseFilename=hobl_installer
Compression=lzma
...
begin
  ...
  if Exec(ExpandConstant('{cmd}'), ExpandConstant('/c powershell.exe c:\hobl\setup_src\src_host\host_setup.ps1 ') + Args, '', SW_SHOW, ewWaitUntilTerminated, ResultCode) then
    begin
