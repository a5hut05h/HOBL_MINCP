...
CreateAppDir=no
OutputDir=..\..
OutputBaseFilename=local_setup
Compression=lzma
...
[Components]
Name: "Framework"; Description: "HOBL test framework and device setup"; Types: Full;
