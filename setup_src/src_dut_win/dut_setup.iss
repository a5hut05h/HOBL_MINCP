...
Source: "..\..\utilities\open_source\HOBLStatusWindow\bin\arm64\Release\net8.0-windows\win-arm64\*"; DestDir: "{tmp}\dut_setup\HOBLStatusWindow-arm64"; Flags: ignoreversion
