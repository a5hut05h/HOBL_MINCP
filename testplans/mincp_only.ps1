...
#.\hobl.cmd -p $ARGS[0] -s mincp_base global:iterations=1 global:run_type=Power global:tools="run_report display auto_recharge power_light powercfg" mincp_base:perf_run=1 mincp_base:mincp_workloads="copilot_query productivity file_explorer start_launch" mincp_base:web_workload="amazonsg amazongot amazonvacuum googleimagesapollo googleimageslondon googlersearchbelgium googlesearchsuperbowl instagram reddit theverge wikipedia youtubenas youtube" mincp_base:simple_office_launch=1 mincp_base:short_typing=1 audio_volume:volume=50 mincp_base:enable_mincp_productivity_trace=1 teams:access_key=3JVBW7x0qREHzTaYja1G6UmtqSN52cqvHuwPexktuhXMVBiil6r7Fw==
.\hobl.cmd -p $ARGS[0] -s consumer_multitasker global:iterations=1 global:run_type=Power global:tools="run_report auto_recharge power_light perf_utc" enterprise_collab:perf_run=1 perf_utc:cm=1
.\hobl.cmd -p $ARGS[0] -s enterprise_collab global:iterations=1 global:run_type=Power global:tools="display auto_recharge power_light powercfg" enterprise_collab:perf_run=1 perf_utc:ec=1
