...
.\hobl.cmd -p $ARGS[0] -s web web:loops="100" global:rundown_mode=1 global:stop_soc=0 global:crit_batt_level=3 screenshot:pause=3600 global:tools="+power_light auto_charge screenshot"
.\hobl.cmd -p $ARGS[0] -s charge_on
